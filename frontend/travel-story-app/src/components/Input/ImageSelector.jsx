...
const ImageSelector = ({ image, setImage,handleDeleteImg }) => {
  ...
  useEffect(() => {
    ...
    if (typeof image === 'string') {
      ...
      //if the image prop is a file object,create preview URL
  ...
  return (
    <div>
      ...
      {!image ? (
        <button
          className="w-full h-[220px] flex flex-col items-center justify-center bg-slate-100 gap-4 rounded border border-slate-200/50 cursor-pointer"
        ...
        <div className="w-full relative">
            <img src={previewUrl} alt="Selected" className="w-full h-[300px] object-contain rounded-lg" />
            <button
