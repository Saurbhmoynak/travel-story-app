...
const TravelStoryCard = ({
  ...
  return (
    <div className='border border-transparent rounded-lg overflow-hidden bg-white hover:shadow-lg hover:shadow-slate-200 transition-all ease-in-out relative cursor-pointer'>
      <img
        src={imgUrl}
        alt={title}
